...
#define FFMPEG_CONFIGURATION "--arch=armv7-a --cpu=cortex-a8 --disable-runtime-cpudetect --target-os=linux --enable-cross-compile --cross-prefix=arm-linux-androideabi- --prefix='/Users/zhangyanlong/work/visionKit/thirdparty/ffmpeg-4.0.5uild' --sysroot=/Users/zhangyanlong/work/visionKit/thirdparty/ffmpeg-4.0.5/build/sysroot/ --enable-version3 --enable-optimizations --disable-fast-unaligned --enable-static --disable-shared --disable-symver --disable-programs --disable-doc --disable-avdevice --disable-postproc --prefix=/Users/zhangyanlong/work/visionKit/thirdparty/ffmpeg-4.0.5/build/android/ --extra-cflags='-std=c99 -O3 -Wall -pipe -fpic -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDK_BUILD -DNDEBUG -U_FILE_OFFSET_BITS -D__ANDROID_API__=22 -march=armv7-a -mfpu=neon -mfloat-abi=softfp -mvectorize-with-neon-quad -fpic' --extra-ldflags='-lm -lz -llog -fPIC -Wl,--no-undefined -D__ANDROID_API__=22 -L/Users/zhangyanlong/work/apps/android-ndk-r17c/platforms/android-21/arch-arm/usr/lib/ '"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "/Users/zhangyanlong/work/visionKit/thirdparty/ffmpeg-4.0.5/build/android//share/ffmpeg"
#define AVCONV_DATADIR "/Users/zhangyanlong/work/visionKit/thirdparty/ffmpeg-4.0.5/build/android//share/ffmpeg"
